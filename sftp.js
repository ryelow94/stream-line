...
//     return;
//   }
  if (!date_regex.test(event.target[5].value)) {
    alert(
  ...
  var clientKey = document.createElement("h3");
  var accounts= document.createElement("h3");
...
//   var edition = document.createElement("h3");
  ...
  var cName= event.target[2].value
  summary.textContent =
    "Lockpath | " + lettersOnly(cName) + " | " + event.target[1].value;
  clientKey.textContent = event.target[2].value;
  accounts.textContent = event.target[3].value;
  ip.textContent = event.target[4].value;
//   customerName.textContent = event.target[5].value;
//   source.textContent = event.target[6].value;
//   purge.textContent = event.target[6].value;
//   edition.textContent = event.target[6].value;
  dueDate.textContent = event.target[5].value;
  priority.textContent = event.target[6].value;
  escalate.textContent = event.target[7].value;
  approved.textContent = event.target[8].value;
  explanation.textContent = event.target[9].value;
